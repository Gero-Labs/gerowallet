  ...
  >
    ...
    >
      ...
      <img
        ...
        style="width: 72px; height: 72px; right: -40px; top: -43px; position: absolute; opacity: 0.96"
        alt=""
      />
      <img
        :src="assets.rectangle2"
        style="width: 32px; height: 32px; right: -60px; top: 13px; position: absolute"
        alt=""
      />
      <img
        :src="assets.rectangle"
