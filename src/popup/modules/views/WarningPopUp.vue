<template>
  <v-form ref="form" v-model="valid" class="fill-height">
    <PopupHeader :title="$t('navigation.warningContinueCaution') as string" ref="popupHeader" :show-website="!($route.query['website'] === 'undefined' || Object.keys($route.query || {}).length === 0)" :show-wallet="false">
