      ...
      >
        ...
        <v-list-item-content>
          ...
          <v-list-item-subtitle style="font-size: 16px;">
            {{ pairSupported ? $t('welcome.pairHardwareWalletDescription') : $t('welcome.pairNotSupportedOnNetwork', { network: network ? network.title : '' }) }}
...
const pairSupported = computed(() => !!props.network?.supportedHardware);
</script>
