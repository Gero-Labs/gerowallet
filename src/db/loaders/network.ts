        ...
        try {
          ...
          const newProtocolParamsInAlonzo = {
            ...
            costModels: epochParams?.cost_models ? new Map<Cardano.PlutusLanguageVersion, Cardano.CostModel>([
              ...(epochParams.cost_models.PlutusV1 ? [[Cardano.PlutusLanguageVersion.V1, Object.values(epochParams.cost_models.PlutusV1)]] : []),
              ...(epochParams.cost_models.PlutusV2 ? [[Cardano.PlutusLanguageVersion.V2, Object.values(epochParams.cost_models.PlutusV2)]] : []),
              ...(epochParams.cost_models.PlutusV3 ? [[Cardano.PlutusLanguageVersion.V3, Object.values(epochParams.cost_models.PlutusV3)]] : []),
            ]) : new Map(),
            prices: {
